...
#Two-dimensional dictionary stores URLs to be returned upon valid request
...
#Default route for the sake of completeness, has no practical value
@app.route('/')
def default():
    return '<p> Default route </p>'

#Dynamic routing provides greater flexibility
